...
func AddRoom(room lib.IRoom) (primitive.ObjectID, lib.IStatus) {
	...
	if err != nil {
		return primitive.ObjectID{}, utils.UpdateError("insert", roomCollectionName, 500, err.Error())
	}
...
func UpdateRoom(room lib.IRoom) (primitive.ObjectID, lib.IStatus) {
	...
	if err != nil {
		fmt.Println("err", err)
		return primitive.ObjectID{}, utils.UpdateError("update", roomCollectionName, 500, err.Error())
	}
...
func RemoveRoom(id primitive.ObjectID) (primitive.ObjectID, lib.IStatus) {
	...
	if err != nil {
		return primitive.ObjectID{}, utils.UpdateError("remove", roomCollectionName, 500, err.Error())
	}
	return id, utils.UpdateError("remove", roomCollectionName, 200, err.Error())
}
